#!/usr/bin/env python3
"""
Stay Open Camera Test - Camera stays open until you close it
"""
...
def main():
    print("🎥 Stay Open Camera Test")
    print("=" * 40)
    print("This test will open the camera and keep it open")
    print("You should see a camera window appear")
    print("=" * 40)
    ...
    print("📱 If you see the window, press 'q' to quit")
    print("📱 If no window appears, press Ctrl+C to stop")
    print("=" * 50)
